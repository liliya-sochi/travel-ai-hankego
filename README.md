...
- rejects summaries that call optional places required, and expects a distinct
  evening park or restaurant on one-day trips when the user requested that
  interest and suitable candidates are available;
